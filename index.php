		...
		<div id="gameSpace">
			...
			<div id="game-header">
				...
				<div id="grid-container2">
					...
					<canvas class = "map" id="2grid-3-3" onclick="stepMatching3('2grid-3-3')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-3-2" onclick="stepMatching3('2grid-3-2')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-3-1" onclick="stepMatching3('2grid-3-1')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-3-0" onclick="stepMatching3('2grid-3-0')" width="150" height="150"></canvas>

					<canvas class = "map" id="2grid-2-3" onclick="stepMatching3('2grid-2-3')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-2-2" onclick="stepMatching3('2grid-2-2')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-2-1" onclick="stepMatching3('2grid-2-1')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-2-0" onclick="stepMatching3('2grid-2-0')" width="150" height="150"></canvas>

					<canvas class = "map" id="2grid-1-3" onclick="stepMatching3('2grid-1-3')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-1-2" onclick="stepMatching3('2grid-1-2')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-1-1" onclick="stepMatching3('2grid-1-1')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-1-0" onclick="stepMatching3('2grid-1-0')" width="150" height="150"></canvas>

					<canvas class = "map" id="2grid-0-3" onclick="stepMatching3('2grid-0-3')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-0-2" onclick="stepMatching3('2grid-0-2')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-0-1" onclick="stepMatching3('2grid-0-1')" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-0-0" onclick="stepMatching3('2grid-0-0')" width="150" height="150"></canvas>
				</div>
			</div>
		</div>
	</body>
