...
<!DOCTYPE html>
	...
	<head lang="en">
		...
		<script type="text/javascript" src="JavaScript/stepMatching-3.js"></script>
	...
	<body>
		<div id="gameSpace">
			...
			<div id="game-header">
				...
				<div id="sequence2">
					<canvas id="2position0" class="seqgrid" width="175" height="175"></canvas>
					<canvas id="2position1" class="seqgrid" width="175" height="175"></canvas>
					<canvas id="2position2" class="seqgrid" width="175" height="175"></canvas>
					<canvas id="2position3" class="seqgrid" width="175" height="175"></canvas>
					<canvas id="2position4" class="seqgrid" width="175" height="175"></canvas>

				</div>


				<div id="sequence3">
					<canvas id="3position0" class="seqgrid" width="150" height="150"></canvas>
					<canvas id="3position1" class="seqgrid" width="150" height="150"></canvas>
					<canvas id="3position2" class="seqgrid" width="150" height="150"></canvas>
					<canvas id="3position3" class="seqgrid" width="150" height="150"></canvas>
					<canvas id="3position4" class="seqgrid" width="150" height="150"></canvas>
					<canvas id="3position5" class="seqgrid" width="150" height="150"></canvas>
				</div>
				...
				<div id="grid-container2">
					...
					<canvas class = "map" id="2grid-3-3" onclick="stepMatching3('2grid-3-3')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-3-2" onclick="stepMatching3('2grid-3-2')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-3-1" onclick="stepMatching3('2grid-3-1')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-3-0" onclick="stepMatching3('2grid-3-0')" onmouseover="shakeRock();" width="150" height="150"></canvas>

					<canvas class = "map" id="2grid-2-3" onclick="stepMatching3('2grid-2-3')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-2-2" onclick="stepMatching3('2grid-2-2')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-2-1" onclick="stepMatching3('2grid-2-1')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-2-0" onclick="stepMatching3('2grid-2-0')" onmouseover="shakeRock();" width="150" height="150"></canvas>

					<canvas class = "map" id="2grid-1-3" onclick="stepMatching3('2grid-1-3')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-1-2" onclick="stepMatching3('2grid-1-2')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-1-1" onclick="stepMatching3('2grid-1-1')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-1-0" onclick="stepMatching3('2grid-1-0')" onmouseover="shakeRock();" width="150" height="150"></canvas>

					<canvas class = "map" id="2grid-0-3" onclick="stepMatching3('2grid-0-3')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-0-2" onclick="stepMatching3('2grid-0-2')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-0-1" onclick="stepMatching3('2grid-0-1')" onmouseover="shakeRock();" width="150" height="150"></canvas>
					<canvas class = "map" id="2grid-0-0" onclick="stepMatching3('2grid-0-0')" onmouseover="shakeRock();" width="150" height="150"></canvas>
				</div>
			</div>
		</div>
	</body>
